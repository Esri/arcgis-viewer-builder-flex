...
public final class DrawModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return 'assets/images/i_draw2.png';
    }

    public function get widgetLabel():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'draw.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'draw.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'draw.widgetHelpURL');
    }
