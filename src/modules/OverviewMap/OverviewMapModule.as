...
public final class OverviewMapModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'overviewMap.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'overviewMap.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'overviewMap.widgetHelpURL');
    }

    public function createWidgetView():IWidgetView
    {
        return new OverviewMapView();
    }

    public function createWidgetModel():IWidgetModel
    {
        return new OverviewMapModel();
    }
