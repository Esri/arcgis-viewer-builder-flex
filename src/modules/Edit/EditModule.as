...
public final class EditModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return 'assets/images/i_edit.png';
    }
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'edit.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'edit.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'edit.widgetHelpURL');
    }
