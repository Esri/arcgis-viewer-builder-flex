...
public class GeoprocessingModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return "assets/images/i_widget.png";
    }
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'geoprocessing.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'geoprocessing.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'geoprocessing.widgetHelpURL');
    }

    public function createWidgetView():IWidgetView
    {
        return new GeoprocessingView();
    }

    public function createWidgetModel():IWidgetModel
    {
        return new GeoprocessingModel();
    }
}
}
