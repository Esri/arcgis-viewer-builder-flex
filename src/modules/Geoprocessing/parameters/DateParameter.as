...
import modules.Geoprocessing.paramEditor.input.InputDateParamEditor;
...
public class DateParameter extends BaseParameter
{
    ...
    {
        var date:Date = new Date();
        date.time = Date.parse(text);
        _defaultValue = date;
    }

    override public function createInputEditorView():IVisualElement
    {
        var editorView:InputDateParamEditor = new InputDateParamEditor();
