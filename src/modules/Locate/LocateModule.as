...
public final class LocateModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return 'assets/images/i_target.png';
    }
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'locate.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'locate.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'locate.widgetHelpURL');
    }
