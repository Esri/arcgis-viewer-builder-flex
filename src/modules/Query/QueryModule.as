...
public final class QueryModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return 'assets/images/GenericSearch32.png';
    }

    public function get widgetLabel():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'query.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'query.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'query.widgetHelpURL');
    }
