...
public final class StaticImageModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'staticImage.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'staticImage.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'staticImage.widgetHelpURL');
    }

    public function createWidgetView():IWidgetView
    {
        return new StaticImageView();
    }

    public function createWidgetModel():IWidgetModel
    {
        return new StaticImageModel();
    }
}
}
