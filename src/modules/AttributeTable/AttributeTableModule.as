...
public final class AttributeTableModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return 'assets/images/TableOpen32.png';
    }
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'attributeTable.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'attributeTable.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'attributeTable.widgetHelpURL');
    }
