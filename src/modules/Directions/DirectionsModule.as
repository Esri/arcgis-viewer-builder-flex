...
public class DirectionsModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'directions.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'directions.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'directions.widgetHelpURL');
    }

    public function createWidgetModel():IWidgetModel
    {
        return new DirectionsModel();
    }

    public function createWidgetView():IWidgetView
    {
        return new DirectionsView();
    }
}
