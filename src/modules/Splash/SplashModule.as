...
public class SplashModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'splash.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'splash.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'splash.widgetHelpURL');
    }
