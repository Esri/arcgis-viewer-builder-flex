...
public final class MapSwitcherModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'mapSwitcher.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'mapSwitcher.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'mapSwitcher.widgetHelpURL');
    }

    public function createWidgetView():IWidgetView
    {
        return new MapSwitcherView();
    }

    public function createWidgetModel():IWidgetModel
    {
        return new MapSwitcherModel();
    }
