...
public final class SearchModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return 'assets/images/i_search.png';
    }

    public function get widgetLabel():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'search.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'search.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'search.widgetHelpURL');
    }
