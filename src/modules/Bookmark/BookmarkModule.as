...
public final class BookmarkModule extends ModuleBase implements IBuilderModule
{
    ...
    {
        return 'assets/images/i_bookmark.png';
    }
    ...
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'bookmark.widgetLabel');
    }

    public function get widgetDescription():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'bookmark.widgetDescription');
    }

    public function get widgetHelpURL():String
    {
        return ResourceManager.getInstance().getString('BuilderStrings', 'bookmark.widgetHelpURL');
    }
