...
public class ConfigureExtentController
{
    public function ConfigureExtentController()
    {
    ...
    {
        updateLastSavedExtent();
    }

    private function updateLastSavedExtent():void
    {
        Model.instance.lastSavedExtent = Model.instance.config.configMap.initExtent;
    }
