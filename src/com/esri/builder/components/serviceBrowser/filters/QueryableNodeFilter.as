...
public class QueryableNodeFilter implements INodeFilter
{
    ...
    protected function isNodeQueryable(node:ServiceDirectoryNode):Boolean
    {
        const queryableNode:QueryableNode = node as QueryableNode;
        return queryableNode && queryableNode.isQueryable;
    }
