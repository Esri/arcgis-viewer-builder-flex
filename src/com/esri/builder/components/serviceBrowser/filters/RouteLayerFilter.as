...
public class RouteLayerFilter implements INodeFilter
{
    public function isApplicable(node:ServiceDirectoryNode):Boolean
    {
        return node is FolderNode || node is NAServerNode || node is RouteLayerNode;
    }

    public function isSelectable(node:ServiceDirectoryNode):Boolean
    {
        return node is RouteLayerNode;
    }
