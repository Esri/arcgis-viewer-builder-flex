...
public class FieldPicker extends FieldPickerBase
{
    override protected function selectedFieldNameAt(index:int):String
    {
        var selectedField:Field = fieldList.dataProvider.getItemAt(index) as Field;
        return selectedField.name;
    }

    override public function defaultFieldLabelFunction(field:Object):String
    {
        return StringUtil.substitute("{0} {{1}}", field.alias, field.name);
    }
}
}
